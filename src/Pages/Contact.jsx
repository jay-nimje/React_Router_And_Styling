                    ...
                    <div className="container py-md-5">
                        ...
                        <div className="row contact_information">
                            <div className="col-md-6">
                                <div className="contact_right p-lg-5 p-4">
                                    <form action="#" method="post">
                                        ...
                                        <div className="field-group">
                                            <div className="content-input-field">
                                                <textarea placeholder="Your Message Here..." required defaultValue={""} />
                                            </div>
                                        </div>
                                        <div className="content-input-field">
                            ...
                            <div className="col-md-6 contact_left p-4">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6350041.310790406!2d30.68773492426509!3d39.0014851732576!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14b0155c964f2671%3A0x40d9dbd42a625f2a!2sTurkey!5e0!3m2!1sen!2sin!4v1522753415269" />
                            </div>
                            <div className="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                                <div className="mt-5 information-wthree">
                                    <h4 className="text-uppercase mb-4"><span className="fa fa-comments" /> Communication</h4>
                            ...
                            <div className="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                                <div className="mt-5 information-wthree">
                                    <h4 className="text-uppercase mb-4"><span className="fa fa-life-ring" /> Technical Support</h4>
                            ...
                            <div className="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                                <div className="mt-5 information-wthree">
                                    <h4 className="text-uppercase mb-4"><span className="fa fa-map" /> Others</h4>
                                    <p className="cont-wthree-para mb-3 text-capitalize">we are ready to help! if you have any queries or issues, contact us for support <label>+12 388 455 6789</label>.</p>
                                </div>
                            </div>
                        </div>
